...
function MultiStepForm(props) {
    ...
    const steps = [
        ...
        },
        {
            ...
            content: <RenderFunctions functions={props.functions} collection={collection} group={group} setForms={props.setForms} forms={props.forms} id={props.id}
                setId={props.setId} variables={props.variables} setVariables={props.setVariables}
